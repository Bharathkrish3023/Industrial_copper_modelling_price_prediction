...
def Selling_Price():
    ...
    if Button:
        ...
        with open("C:/Users/BharathKrishna.S/OneDrive/Desktop/cop/model.pkl", 'rb') as file1:
...
def Predict_Status():
    ...
    if Button:
        #load the saved model
        with open("C:/Users/BharathKrishna.S/OneDrive/Desktop/cop/classfier_model.pkl", 'rb') as file2:
...
def home():
    ...
    st.write('')
    st.markdown("**:blue[Github link - ] https://github.com/Bharathkrish3023?tab=repositories**")
...
if user=='Home':
    home()
    st.image(Image.open("C:/Users/BharathKrishna.S/OneDrive/Desktop/cop/2263a942-f32c-440c-bb9a-9274dc6848fc.jfif"), width=640)
